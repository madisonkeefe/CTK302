...
function setup() {
  ...
  beeImage = loadImage("assets/beee.png");
  honey = loadImage("assets/honeyy.png");
  imageMode(CENTER);
  rectMode(CENTER);
  noStroke();
}
...
function draw() {
 ...
 // ellipse(0, 0, 80, 80);
  ...
  textSize(40);
  textAlign(CENTER);
  text("SAVE THE BEES!", width / 2, 600, windowWidth - 200, windowHeight - 200);
...
function Car() {
  ...
  this.display = function() {
    image(honey, this.pos.x +17 , this.pos.y-30, 80,60);
